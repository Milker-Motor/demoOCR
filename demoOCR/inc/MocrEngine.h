...
+ (CMocrEngine*) createSharedEngineWithDataSources:(NSArray*)dataSources
										   license:(CMocrLicense*)license OBJC_ARC_UNAVAILABLE;

+ (CMocrEngine*) createArcSharedEngineWithDataSources:(NSArray*)dataSources
										   license:(CMocrLicense*)license;
// Create CMocrEngine singleton instance.
// If CMocrEngine instance already exists then NSException is thrown.
+ (CMocrEngine*) createSharedEngineWithDataSources:(NSArray*)dataSources
										   license:(CMocrLicense*)license
							   dataFilesExtensions:(CMocrDataFilesExtensions*)dataFilesExtensions OBJC_ARC_UNAVAILABLE;
...
@interface CArcMocrEngine : CMocrEngine {
	
}
@end


@interface CNonArcMocrEngine : CMocrEngine {
